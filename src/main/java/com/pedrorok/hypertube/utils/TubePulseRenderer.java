...
public final class TubePulseRenderer {
    ...
    public static void start(BlockPos originBlockPos, BezierConnection connection, boolean invertDir,
        ...
        if (invertDir) {
            relativePoints = new ArrayList<>(relativePoints);
            Collections.reverse(relativePoints);
        }
    ...
    public static void onRenderLevelStage(PoseStack poseStack, float partialTick, Camera camera) {
