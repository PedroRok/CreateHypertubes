...
public class JunctionEntityRenderer implements BlockEntityRenderer<HyperJunctionBlockEntity> {
    ...
    // The render bounding box is widened by TubeBlockEntity#getRenderBoundingBox on this branch,
    // since BlockEntityRenderer has no getRenderBoundingBox hook on 1.20.1.
}
