...
public class AttachmentScenes {
    ...
    public static void attachmentScene(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.of(4.2, 1., 2.5), Pointing.RIGHT)
                .rightClick()
                .withItem(tubeScannerItem.getDefaultInstance()), 40);
        scene.idle(5);
        changeAttachment(scene, entrancePos, Direction.NORTH, tubeScannerItem.getTubeAttachment());
        scene.idle(5);
        scene.overlay
                .showText(70)
                .attachKeyFrame()
        ...
        ElementLink<ParrotElement> birb = scene.special
                .createBirb(new Vec3(1.5, 1, 2.5), ParrotElement.DancePose::new);
        ...
        changeAttachment(scene, acceleratorPos, Direction.NORTH, tubeScannerItem.getTubeAttachment());
        ...
        ElementLink<ParrotElement> birb2 = scene.special
                .createBirb(new Vec3(0, 1.1, 2.5), ParrotElement.FlappyPose::new);
        ...
        scene.overlay.showControls(
                new InputWindowElement(Vec3.atCenterOf(entrancePos).add(0.8, -0.5, 0), Pointing.RIGHT)
                        .rightClick()
        ...
        scene.overlay.showControls(
                new InputWindowElement(Vec3.atCenterOf(entrancePos).add(0.8, -0.5, 0), Pointing.RIGHT)
                        .rightClick()
                        .withItem(redstoneDetectorItem.getDefaultInstance()), 60);
        scene.idle(5);
        changeAttachment(scene, acceleratorPos, Direction.NORTH, redstoneDetectorItem.getTubeAttachment());
        scene.overlay
                .showText(80)
                .attachKeyFrame()
                .pointAt(util.vector.of(3.5, 1.0, 2.5))
        ...
        scene.idle(60);
        scene.overlay.showControls(
                new InputWindowElement(Vec3.atCenterOf(redstoneLampPos).add(0.2, -0.1, 0), Pointing.RIGHT)
                        .rightClick(), 20);
        scene.idle(5);
    ...
    private static void powerEverything(SceneBuildingUtil util, SceneBuilder scene, boolean activate, boolean ignoreLamp) {
    ...
    private static void changeToPower(BlockPos pos, SceneBuilder scene, int power) {
        scene.world.modifyBlock(pos, state -> state.setValue(RedStoneWireBlock.POWER, power), false);
    }

    private static void setSystemSpeed(SceneBuildingUtil util, SceneBuilder scene, int entranceSpeed) {
